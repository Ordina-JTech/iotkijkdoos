...
class ScanVC: UIViewController, UITableViewDelegate, UITableViewDataSource, BluetoothConnectionDelegate {
    ...
    override func viewDidLoad() {
        ...
        //De bluetoothConnection class self maken.
        blue.delegate = self
        
        //Als bluetooth == poweredOn gaan scannen.
        guard blue.manager.state == .poweredOn else {return}
        blue.startScanning()
    ...
    //Wordt aangeroepen door segue. Te zorgen dat de data aan de VC wordt doorgegeven.
    func setDelegate()  {
        blue.delegate = self
    }
